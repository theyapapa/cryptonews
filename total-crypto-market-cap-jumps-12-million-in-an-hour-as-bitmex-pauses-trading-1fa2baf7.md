...
10 대 가상 화폐 중 하나를 제외한 모든 것은 오늘날 급증 하는 동안 주요 성장을 보 았으 며, 각 시간은 언론에 하루에 4 ~ 9%를 확보 했습니다.

암호화 페르소나와 자기 설명 "crypto 예언자" beastlorion은 bitmex의 예정 된 셧다운에 이르는 시간에 일련의 트위터 여론 조사를 게시 하 여 이동이 비트 코인의 가격에 영향을 줄 것 이라고 제안 했습니다.

bitmex는 자신의 사이트에서 추적 서비스 상태가 "\ [t \] 이기 때문에 코인 마켓 캡의 Bitcoin 가격과 거래량 평균에 나열 되지 않습니다. bitmex의 BTC/USD 시장은 실제로 비트 코인을 현물 거래 하지 않는 파생 상품 시장입니다.

공식 웹 사이트에서 bitmex는 "비트 코인으로 구입 및 판매 되는 레 버리지 계약을 제공 하는 p2p 거래 플랫폼"으로 서, 매일 $37억6000만의 거래량을 보고 합니다.
