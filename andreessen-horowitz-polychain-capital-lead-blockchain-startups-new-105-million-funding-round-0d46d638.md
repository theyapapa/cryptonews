...
두 폴 리 체인과 andreessen 투자 펀드 a16z를 통해 이전에 시작의 투자에 참여 했다, 2 월 $6100만 라운드에 기여 했다.

2015에 있는 그것의 기초부터 $2억의 밑에 다만 토탈을 올렸다, dfinity는 궁극적으로 "공용 네트워크에 소프트웨어와 서비스의 세계의 차세대를 접대 할 플 래 트 홈을 창조 하 고 싶다," techcrunch는 a16z 협동자 Chris dixon를 인용 한다 말하는.

"인터넷 컴퓨터는 미래 기술 스택의 중요 한 부분이 되기 위해 궤도에 있다" 고 덧붙였다.

이 이동은 andreessen에서 암호 화폐 영역에 대 한 추가 약정을 표시 하며, 4 월에 회사는 블록 체인 프로젝트를 기반으로 한 $1억3300만 자금 조달의 일부가 되 고 있습니다.
