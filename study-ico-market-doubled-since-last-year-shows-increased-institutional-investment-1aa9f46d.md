...
El informe señala: "los fondos recaudados por el proyecto EOS representan la mayor parte de este aumento, han recolectado $4.197.956.135 para un ICO de un año de duración".

Los informes agregan: "los proyectos basados en Asia mostraron un aumento en los fondos recaudados (+ 20%), pero una disminución en el número de proyectos lanzados (– 40%)."

Según el estudio, esto da lugar a un ambiente en el cual los requisitos del proyecto aumentan, mientras que la cantidad de fondos levantados durante icos se vuelve cada vez más dependiente en "Qué bien los proyectos cooperan con los fondos de inversión."

Los servicios financieros llevaron a todas las demás industrias, tanto en la cantidad de fondos atraídos, como en el número de proyectos.
