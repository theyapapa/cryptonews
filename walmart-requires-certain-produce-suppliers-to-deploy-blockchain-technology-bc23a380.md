...
식품 안전 회사의 부사장, 프랭크 yiannas, 그 월마트는 내년 이내에 다른 신선한 과일과 야채 제공 업체에 대 한 "유사한 추적 시스템을 요구할 것 이라고 밝혔다."

월마트는 100 이상의 기업이 IBM의 블록 체인 서비스를 구현 하는 데 필요한 것 이라고 블룸버그 말했다.

로이터 통신에 따르면, 미국 질병 관리국 예방 센터 (CDC)는 월마트와 건강 관리가 식중독의 발발을 추적 하 고 처리 하는 것을 돕도록 제품 추적 가능성을 개량 하기 위하여 상담 했습니다.

최근 walmart는 안전한 배송 개선, 스마트 기기 관리 방법, 의료 정보 시스템 등 여러 가지 다른 블록 체인 애플리케이션에 대 한 기술 관련 특허를 제출 했습니다.
