...
20 일 EMA 이상의 황소 규모의 경우, 다음 오버 헤드 저항은 하강 채널 및 채널 바로 위에 있는 50 일 SMA의 하향 추세 라인입니다.

# # bch/USD 비트 코인 현금은 이동 평균 아래로 추세와 부정적인 영토에서 RSI 모두 강력한 하향 추세에 남아 있다.

# # xlm/달러 스텔라는 $0.184의 중요 한 지원에서 상승 했지만 지난 3 일 동안 20 일 EMA에서 저항을 직면 하고있다.

LTC/USD 쌍은 20 일 EMA, 다운 트렌드 라인 및 50 데이 SMA에서 위쪽에 딱딱하게 저항을 직면할 것 이다.
