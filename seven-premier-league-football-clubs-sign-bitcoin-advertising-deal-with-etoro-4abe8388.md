...
블록 체인 및 가상 화폐 통합 축구 경기장과 업계에서 또한 파트너십에 대 한 초점을 형성 한다, etoro 지금까지 "탐사의 성격에 대 한 세부 정보를 제공 하지."

이동은 주류 축구에 있는 암호 화폐 통합을 위한 신선한 공정 표를 표시 한다.

Harunustaspor는 1 월에 비트 코인을 위한 프로 선수를 고용 하는 터키를 포함 한 다른 클럽에서 이미 산발적 인 실험을 했습니다.

"이것은 매우 비트 코인과 기본 블록 체인 기술을 수용 하는 축구에 긴도로에 대 한 첫 번째 단계입니다," etoro의 영국 전무 이사이 크 크 v. 간디는 한편 드럼에 의해 인용 했다.
