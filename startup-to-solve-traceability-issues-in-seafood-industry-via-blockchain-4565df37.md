...
2017부터, eachmile는 fishcoin 블록 체인 네트워크와 데이터를 공유 하는 소규모 어 부와 물고기 농민을 위한 도구로 mfish을 reimagining 되었습니다.

# # 물고기를 사랑 하는 블록 체인 fishcoin 백서는 공급 체인 비효율성에 부분적으로 뿌리를 두고 있는 해산물 업계의 문제를 설명 합니다.

# # 산업 인센티브 fishcoin 모델은 fishcoin 토큰을 사용 하 여 소액 거래를 통해 보람 있는 해산물 생산자와 공급 체인 중 개인을 위한 메커니즘을 만듭니다.

이름은 무엇을 제안할 수 있습니다에도 불구 하 고, 토큰은 해산물 거래에 대 한 통화는 아니지만, "메커니즘을 다양 한 형태의 데이터 캡처 및 전송을 incentivizing, 핵심 데이터 요소 (kdes)의 목적을 위해 어 부와 생선 농민에 의해 캡처된 시작 "백서를 읽습니다.
