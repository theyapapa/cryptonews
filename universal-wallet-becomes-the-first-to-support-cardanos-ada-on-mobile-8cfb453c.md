...
Infinito Wallet dice que el hito coincide con una actualización de la versión 1.15.0 de su plataforma, lo que permite a los usuarios "enviar, recibir y comprobar de forma segura el historial de transacciones de ADA".

Con el permiso y el apoyo de IOHK, infinito ha contribuido con el código abierto del proyecto Cardano Rust para la integración de la billetera móvil ADA y continuará con este apoyo para la comunidad de código abierto de Cardano.
