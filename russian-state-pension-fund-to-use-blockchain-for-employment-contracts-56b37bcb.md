...
국가 노동 검사관 통계에 의해 인용 izvestiya 표시 이상 465000 러시아 시민 들이 노동 권리를 주장 2017에 위반 했다.

마찬가지로 지역 뉴스 대행사 tass 오늘, 러시아 총리는 드미트리 메 드 베 데 프 최근 2020에서 시작 하는 모든 고용 기록을 온라인으로 저장 하는 제안 했다.

블록 체인으로 전환 하는 pfr의 결정은 중반-2018에 도입 된 러시아 정부의 급진적인 연금 개혁의 배경을 상대로 온다.

러시아에 대 한 미국과 유럽의 경제 제재에서 압력의 광범위 한 맥락에서, 연금 개혁은 국가에 엄청난 반발을 촉발 시켰다.
