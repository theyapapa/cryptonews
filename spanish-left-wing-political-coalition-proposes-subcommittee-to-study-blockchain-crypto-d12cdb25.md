...
unidos podemos는 최근에 국가의 정부에 있는 블록 체인 채용을 건의 한 유일한 정치 조직이 아니다.

이번 여름 초, 스페인 여당의 133 대의원, parando 인기 (인민 파티), 국가의 공공 행정에 블록 체인을 사용 하는 법안을 제안 했다.

최근 두 개의 주요 스페인어 공공 기관, 저자 및 출판사의 스페인 사회 (sgae)와 마드리드 통신 공학 학교 (etsit-upm)는 디지털 저작권 관리를 위한 블록 체인을 적용 하는 제휴.

암호화 규제의 측면에서, 스페인 의회는 5 월 30, 2018에 블록 체인 기술과 가상 화폐를 규제 하는 초안 규제 프레임 워크에 대 한만 장 일치 지원을 표명 했다.
