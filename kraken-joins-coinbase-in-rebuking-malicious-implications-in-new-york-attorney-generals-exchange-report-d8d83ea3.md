...
언급 여러 번 크 라 켄 "" 정보를 제공 하는, 덤 불, 교환 주장에 참여 하는 것을 거부, 그것은, 같은 뉴욕 거주자에 게 bitlicense를 개최 하지 않고 서비스를 제공 하는 등 숨길 게 있 었 제안 하는 것으로 나타났다.

kraken가 정보를 공급 하지 않는 그것의 결정에서 혼자서이 지 않는 동안, 언더우드는 그것을 "경보"로 기술 하는 교환의 행동을 밖으로 골라 내는 것 처럼 보였다.

"(법무 장관의 사무실) 속임수 또는 학대 무역에 관하여 비 참여 플 래 트 홈 (binance, Gate.io, huobi 및 kraken)의 연습 그리고 절차를 검토할 수 없었다," 보고에 있는 1 개의 참고는 읽는다.

"그러나 kraken 플랫폼의 공공의 응답은 놀랍다.
